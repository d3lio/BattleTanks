...
use gliw::{
    ...
    Vao, Buffer, BufferType, BufferUsagePattern,
    AttribFloatFormat, Uniform, UniformData,
};

use self::cgmath::{Vector2, VectorSpace, InnerSpace, Matrix4};
...
impl OverlayData {
    pub fn new(width: u32, height: u32) -> OverlayData {
        ...
        unsafe { Uniform::new(&prog, "proj").value(UniformData::FloatMat(4, false, &mem::transmute::<_, [f32; 16]>(proj_mat))); }
